...
class Network(object):
    ...
    def add_filter(self, address, main=None, config=None, instances=1):
        """Adds a filter component to the network.
    
        Keyword arguments:
        @param address: The component event bus address.
        @param main: The filter main.
        @param config: The filter component configuration.
        @param instances: The number of filter instances.
    
        @return: A new filter component definition.
        """
        if main is not None and config is not None:
            return Component(self._network.addFilter(address, main, map_to_java(config), instances))
        elif main is not None:
            return Component(self._network.addFilter(address, main, instances))
        elif config is not None:
            return Component(self._network.addFilter(address, map_to_java(config), instances))
        else:
            return Component(self._network.addFilter(address).setInstances(instances))

    def add_splitter(self, address, main=None, config=None, instances=1):
        """Adds a splitter component to the network.
    
        Keyword arguments:
        @param address: The component event bus address.
        @param main: The splitter main.
        @param config: The splitter component configuration.
        @param instances: The number of splitter instances.
    
        @return: A new splitter component definition.
        """
        if main is not None and config is not None:
            return Component(self._network.addSplitter(address, main, map_to_java(config), instances))
        elif main is not None:
            return Component(self._network.addSplitter(address, main, instances))
        elif config is not None:
            return Component(self._network.addSplitter(address, map_to_java(config), instances))
        else:
            return Component(self._network.addSplitter(address).setInstances(instances))

    def add_aggregator(self, address, main=None, config=None, instances=1):
        """Adds an aggregator component to the network.
    
        Keyword arguments:
        @param address: The component event bus address.
        @param main: The aggregator main.
        @param config: The aggregator component configuration.
        @param instances: The number of aggregator instances.
    
        @return: A new aggregator component definition.
        """
        if main is not None and config is not None:
            return Component(self._network.addAggregator(address, main, map_to_java(config), instances))
        elif main is not None:
            return Component(self._network.addAggregator(address, main, instances))
        elif config is not None:
            return Component(self._network.addAggregator(address, map_to_java(config), instances))
        else:
            return Component(self._network.addAggregator(address).setInstances(instances))
    ...
    def components(self):
        ...
        while iterator.hasNext():
            components.append(Component(iterator.next()))
        return components
